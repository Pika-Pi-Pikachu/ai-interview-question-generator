...
const SummaryCard = ({
  ...
  return   <div
      className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-sm shadow-gray-100 relative group"
      onClick={onSelect}
    >
      <div
        className="rounded-lg p-4 cursor-pointer relative bg-gradient-to-b from-[#171532] to-[#08090d] backdrop-blur-md border border-gray-700 text-[#dddfff]"
          ...
          <div className="flex-grow">
            <div className="flex justify-between items-start">
              ...
              <div>
                ...
                <p className="text-xs text-medium text-[#dddfff]">
                  {topicsToFocus}
                </p>
              </div>
            </div>
