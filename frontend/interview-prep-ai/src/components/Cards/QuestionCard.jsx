...
const QuestionCard = ({
  ...
  return <>
      <div className="bg-white rounded-lg mb-4 overflow-hidden py-4 px-5  border border-gray-100/60 group">
        <div className="flex items-start justify-between cursor-pointer">
          ...
          <div className="flex items-center justify-end ml-4 relative">
            ...
            >
              ...
              <button
                className="flex items-center gap-2 text-xs text-[#dddfff] font-medium bg-gradient-to-b from-[#171532] to-[#08090d] backdrop-blur-md border border-gray-700 px-3 py-1 mr-2 rounded text-nowrap border border-cyan-50 hover:border-cyan-200 cursor-pointer"
                onClick={() => {
                  setIsExpanded(true);
                  onLearnMore();
                }}
